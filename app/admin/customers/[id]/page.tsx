  ...
  return (
    <div className="mx-auto max-w-[1200px] px-4 py-8 sm:px-6 sm:py-10">
      ...
      <div className="mt-4 flex flex-wrap items-start justify-between gap-6">
        <div>
          <h1 className="font-display text-3xl font-light text-foreground">{customer.name}</h1>
      ...
      <div className="mt-8 grid grid-cols-3 gap-6 border border-foreground/10 p-6">
        <div>
          <p className="font-sans text-xs font-light tracking-[0.18em] text-foreground/45 uppercase">
            Total Orders
          </p>
          <p className="mt-2 font-sans text-2xl font-light tracking-wide text-foreground tabular-nums">{customer.orderCount}</p>
        </div>
        <div>
          <p className="font-sans text-xs font-light tracking-[0.18em] text-foreground/45 uppercase">
            Total Spent
          </p>
          <p className="mt-2 font-sans text-2xl font-light tracking-wide text-foreground tabular-nums">
        ...
        <div>
          ...
          <p className="mt-2 font-sans text-2xl font-light tracking-wide text-foreground">
