  ...
  return (
    <div className="flex min-h-[70vh] items-center bg-background pt-16 lg:pt-20">
      <Container className="flex flex-col items-center gap-6 py-24 text-center">
        <p className="font-serif text-7xl font-light text-foreground/20 sm:text-8xl">404</p>
        <h1 className="font-serif text-3xl font-light text-foreground sm:text-4xl">This page isn&rsquo;t on the rack.</h1>
