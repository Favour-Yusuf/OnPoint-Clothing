  ...
  return (
    <div className="flex min-h-[70vh] items-center bg-background pt-16 lg:pt-20">
      <Container className="flex flex-col items-center gap-6 py-24 text-center">
        <p className="font-sans text-xs font-light tracking-[0.3em] text-burgundy uppercase">Something Went Wrong</p>
        <h1 className="font-display text-3xl font-light text-foreground sm:text-4xl">We hit a snag.</h1>
