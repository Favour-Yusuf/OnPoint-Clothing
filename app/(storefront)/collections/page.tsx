  ...
  return (
    <div className="bg-background pt-16 lg:pt-20">
      <Container className="py-12 sm:py-16">
        <p className="font-sans text-xs font-medium tracking-[0.35em] text-burgundy uppercase">Collections</p>
        <h1 className="mt-4 font-serif text-4xl leading-[1.05] font-light text-foreground sm:text-5xl">
          ...
          <Reveal key={collection.slug} delayMs={index * 80}>
            ...
            >
              ...
              <div className="relative z-10 flex w-full items-end justify-between gap-6 p-6 sm:p-10">
                <div>
                  <p className="font-sans text-xs font-medium tracking-[0.3em] text-burgundy uppercase">{collection.season}</p>
                  <h2 className="mt-2 font-serif text-3xl font-light text-foreground sm:text-4xl">{collection.name}</h2>
