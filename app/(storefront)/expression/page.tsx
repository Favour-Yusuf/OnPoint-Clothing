...
import { ExpressionExperience } from "@/components/expression/expression-experience";
import { ExpressionLooks } from "@/components/expression/expression-looks";
import { ExpressionGallery } from "@/components/expression/expression-gallery";
      ...
      <section className="relative overflow-hidden border-t border-burgundy/25 bg-background py-28 sm:py-36">
        ...
        <Container className="relative z-10 flex flex-col items-center gap-8 text-center">
          ...
          <h2 className="font-display text-4xl leading-[1.05] font-light text-foreground sm:text-6xl">
            Discover <em className="text-burgundy-light not-italic">the collection.</em>
          </h2>
