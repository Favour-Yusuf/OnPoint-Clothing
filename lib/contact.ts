...
export const CONTACT = {
  ...
  email: { display: "support@justonpointng.com", href: "mailto:support@justonpointng.com" },
  /** Data-rights requests specifically — see the Privacy Policy's "Your Rights" and "Contact Us" sections. */
  privacy: { display: "privacy@justonpointng.com", href: "mailto:privacy@justonpointng.com" },
  address: {
